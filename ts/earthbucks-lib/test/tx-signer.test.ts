...
describe("TxSigner", () => {
  ...
  test("should sign a tx", () => {
    ...
    const sigBuf = txInput.script.chunks[0].buf as EbxBuf;
    expect(sigBuf?.length).toBe(65);
    const pubKeyBuf = txInput.script.chunks[1].buf as EbxBuf;
  ...
  test("should sign two inputs", () => {
    ...
    const sigBuf1 = txInput1.script.chunks[0].buf as EbxBuf;
    expect(sigBuf1?.length).toBe(65);
    const pubKeyBuf1 = txInput1.script.chunks[1].buf as EbxBuf;
    ...
    const sigBuf2 = txInput2.script.chunks[0].buf as EbxBuf;
    expect(sigBuf2?.length).toBe(65);
    const pubKeyBuf2 = txInput2.script.chunks[1].buf as EbxBuf;
