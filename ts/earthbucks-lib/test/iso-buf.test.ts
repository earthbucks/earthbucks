...
describe("IsoBuf", () => {
  test("to/from buf", () => {
    ...
    const isoBuf = IsoBuf.fromBuf(buf.length, buf);
  ...
  test("to/from base58", () => {
    ...
    const isoBuf2 = IsoBuf.fromBase58(buf.length, base58);
...
describe("FixedIsoBuf", () => {
  test("to/from buf", () => {
    const buf = Buffer.from("deadbeef", "hex");
    const fixedIsoBuf = FixedIsoBuf.fromBuf(4, buf);
  ...
  test("to/from base58", () => {
    ...
    const fixedIsoBuf2 = FixedIsoBuf.fromBase58(4, base58);
