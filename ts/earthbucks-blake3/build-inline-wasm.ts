...
const wasmPath = join(__dirname, "src", "rs-blake3-bundler", `${NAME}_bg.wasm`);
const wasmBase64 = readFileSync(wasmPath).toString("base64");

const wasmJsCode = `
import * as earthbucks_blake3_bg from './earthbucks_blake3_bg.js';
const wasmBase64 = "${wasmBase64}";
const wasmBinary = Uint8Array.from(atob(wasmBase64), c => c.charCodeAt(0));
const wasmModule = new WebAssembly.Module(wasmBinary);
const importObject = { './earthbucks_blake3_bg.js': earthbucks_blake3_bg };
