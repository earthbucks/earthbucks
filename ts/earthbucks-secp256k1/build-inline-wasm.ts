...
const NAME = "earthbucks_secp256k1";
...
const wasmPath = join(__dirname, "src", "rs-secp256k1-bundler", `${NAME}_bg.wasm`);
const wasmBase64 = readFileSync(wasmPath).toString("base64");

const wasmJsCode = `
import * as earthbucks_secp256k1_bg from './earthbucks_secp256k1_bg.js';
const wasmBase64 = "${wasmBase64}";
const wasmBinary = Uint8Array.from(atob(wasmBase64), c => c.charCodeAt(0));
const wasmModule = new WebAssembly.Module(wasmBinary);
const importObject = { './earthbucks_secp256k1_bg.js': earthbucks_secp256k1_bg };
