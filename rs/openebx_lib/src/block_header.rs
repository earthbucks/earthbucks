...
impl BlockHeader {
    ...
    pub fn to_u8_vec(&self) -> Vec<u8> {
        ...
        bw.write_u64_be(self.block_number);
        bw.to_u8_vec()
    }
    ...
    pub fn is_genesis(&self) -> bool {
        self.block_number == 0 && self.prev_block_id.iter().all(|&x| x == 0)
    }
    ...
    pub fn from_prev_block_header(
        ...
        let index = prev_block_header.block_number + 1;
        ...
        if index % BlockHeader::BLOCKS_PER_ADJUSTMENT == 0 {
            match prev_adjustment_block_header {
                Some(pabh) if pabh.block_number + BlockHeader::BLOCKS_PER_ADJUSTMENT == index => {
...
mod tests {
    ...
    fn test_to_u8_vec_and_from_u8_vec() {
        ...
        assert_eq!(bh1.block_number, bh2.block_number);
    }
    ...
    fn test_from_prev_block_header_adjustment() {
        ...
        .unwrap();
        assert_eq!(bh.block_number, BlockHeader::BLOCKS_PER_ADJUSTMENT);
