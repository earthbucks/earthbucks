...
mod tests {
    ...
    fn test_tx_input() -> Result<(), String> {
        ...
        let script = Script::from_strict_str("");
        let lock_rel = 0;
        ...
        match (
            tx_input.script.to_strict_str(),
            tx_input2.script.to_strict_str(),
        ) {
    ...
    fn test_from_buf_reader() {
        ...
        let script_hex = "";
        let script = Script::from_strict_str(script_hex);
        let lock_rel = 2u32;
        ...
        let script2_hex = match script2.to_strict_str() {
    ...
    fn test_is_null() {
        let tx_input = TxIn {
            input_tx_id: [0; 32],
            input_tx_out_num: 0,
            script: Script::from_strict_str("0x121212").unwrap(),
            lock_rel: 0,
        };
