    ...
    match args.len() {
        ...
        2 => match args[1].as_str() {
            "key" => {
                ...
                let priv_key_str = key.priv_key.to_strict_str();
                let pub_key_str = key.pub_key.to_strict_str();
            ...
            "pkh" => {
                ...
                let prv_key_str = key.priv_key.to_strict_str();
                let pub_key_str = key.pub_key.to_strict_str();
                let pkh_str = pkh.to_strict_str();
